...
import msg, msgarena, msglooper, mpscfifo, fifoutils, tables, hashes
...
proc newStateInfo[TypeState](sm: ptr StateMachine[TypeState],
...
proc startStateMachine*[TypeState](sm: ptr StateMachine[TypeState], initialState: TypeState) =
  ## Start the state machine at initialState
  ## TODO: More to do when hierarchy is implemented
  sm.curState = initialState

proc addState*[TypeState](sm: ptr StateMachine[TypeState], state: TypeState, parent: TypeState = nil) =
...
when isMainModule:
  ...
  suite "t1":
    ...
    proc default(sm: ptr SmT1, msg: MsgPtr)
